...
### 修复方案
1. 创建专用脚本：`skills/instagram-automator-core/scripts/lightweight_collect.py`
...
### 文件修改
- ✅ 新增：`skills/instagram-automator-core/scripts/lightweight_collect.py`
...
### 修复方案
1. 创建一键设置脚本：`skills/instagram-automator-core/scripts/setup_dashboard.py`
...
### 文件修改
- ✅ 新增：`skills/instagram-automator-core/scripts/setup_dashboard.py`
...
### 长期（下季度）
- [ ] 支持多平台发布（Instagram Shorts、Instagram Reels）
- [ ] 支持自定义视频模板
- [ ] 添加 A/B 测试功能
