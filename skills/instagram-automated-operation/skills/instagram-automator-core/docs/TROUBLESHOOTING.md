...
本文档记录了 Instagram Automator 运行过程中可能遇到的问题及解决方案。
...
### 解决方案
✅ 已修复：使用专用脚本 `skills/instagram-automator-core/scripts/lightweight_collect.py`
...
2. 提交 Issue：
   - GitHub: https://github.com/your-repo/instagram-automator
   - 或联系技术支持
