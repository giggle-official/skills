...
- **手动更新**：`python3 skills/youtube-automator-core/scripts/dashboard_integration.py update`
...
- **修改文件**：`skills/youtube-automator-core/scripts/dashboard_integration.py`
