#!/usr/bin/env python3
"""
30 秒 AIMV 托管模式 API 调用脚本（项目 type 为 aimv-30，其余与 giggle-generation-aimv 一致）
...
class MVTrusteeAPI:
    """30 秒 AIMV（aimv-30）托管模式 API 客户端"""
...
def main():
    parser = argparse.ArgumentParser(description="30 秒 AIMV（aimv-30）托管模式 API 调用工具", formatter_class=argparse.RawDescriptionHelpFormatter)
