# Twitter Automator - 全自动 Twitter 内容运营系统

**最自律的 Twitter 内容机器** — 它比你早起，追踪全网热点，深度提炼，写脚本拍视频，自动发 Twitter。你只管看播放量涨。
...
│   ├── x2c-socialposter/        # Twitter 发布技能
│   ├── claw-dashboard/          # Dashboard 技能
│   └── twitter-automator-core/   # 核心脚本
│       └── scripts/
