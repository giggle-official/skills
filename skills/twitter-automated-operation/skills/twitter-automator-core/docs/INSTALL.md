...
本文档详细说明如何安装和配置 Twitter 自媒体运营 Agent。
...
| **X2C API** | Twitter 发布 | [x2creel.ai](https://www.x2creel.ai) | 免费/付费套餐 |
...
# 1. 下载 Agent
cd ~/.openclaw/
git clone <your-repo-url> workspace-twitter-automated-operation

# 2. 进入目录
cd workspace-twitter-automated-operation
...
问: "请提供你的 X2C API Key"
→ 在 https://www.x2creel.ai 注册后获取，并关联 Twitter 账号
```
...
# 2. 删除 Agent 目录
rm -rf ~/.openclaw/workspace-twitter-automated-operation
