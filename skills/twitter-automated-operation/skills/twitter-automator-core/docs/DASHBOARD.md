...
- **手动更新**：`python3 skills/twitter-automator-core/scripts/dashboard_integration.py update`
...
- **修改文件**：`skills/twitter-automator-core/scripts/dashboard_integration.py`
