...
本文档记录了 Twitter Automator 运行过程中可能遇到的问题及解决方案。
...
### 解决方案
✅ 已修复：使用专用脚本 `skills/twitter-automator-core/scripts/lightweight_collect.py`
...
2. 提交 Issue：
   - GitHub: https://github.com/your-repo/twitter-automated-operation
   - 或联系技术支持
