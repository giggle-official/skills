...
- **手动更新**：`python3 skills/tiktok-automator-core/scripts/dashboard_integration.py update`
...
- **修改文件**：`skills/tiktok-automator-core/scripts/dashboard_integration.py`
