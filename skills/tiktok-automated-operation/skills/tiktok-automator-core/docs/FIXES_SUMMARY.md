...
### 修复方案
1. 创建专用脚本：`skills/tiktok-automator-core/scripts/lightweight_collect.py`
...
### 文件修改
- ✅ 新增：`skills/tiktok-automator-core/scripts/lightweight_collect.py`
...
### 修复方案
1. 创建一键设置脚本：`skills/tiktok-automator-core/scripts/setup_dashboard.py`
...
### 文件修改
- ✅ 新增：`skills/tiktok-automator-core/scripts/setup_dashboard.py`
