# TikTok Automator - 全自动 TikTok 内容运营系统

**最自律的 TikTok 内容机器** — 它比你早起，追踪全网热点，深度提炼，写脚本拍视频，自动发 TikTok。你只管看播放量涨。
...
│   ├── x2c-socialposter/        # TikTok 发布技能
│   ├── claw-dashboard/          # Dashboard 技能
│   └── tiktok-automator-core/   # 核心脚本
│       └── scripts/
