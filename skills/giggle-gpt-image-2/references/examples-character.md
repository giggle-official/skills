# Character Design Cases｜角色设计（9条）

## 目录
- [Case 1: Anime Snapshot Conversion](#case-1)
- [Case 2: Persona5 Character Reference Card](#case-2)
- [Case 3: Gal Game Character Introduction Page](#case-3)
- [Case 5: Official Character Sheet (JP)](#case-5)
- [Case 7: Mecha Girl Sea-City Key Visual](#case-7)
- [Case 8: Saint Seiya Gold Saints Card Grid](#case-8)
- [Case 9: Chaos Notes Hidden Face Character Art](#case-9)

---

### Case 1
**Anime Snapshot Conversion** — 照片转动漫截图风
...
### Case 2
**Persona5 Character Reference Card** — 角色设定资料卡（中文版）
...
### Case 3
**Gal Game Character Introduction Page** — Galgame 角色介绍页
...
### Case 5
**Official Character Sheet (JP)** — 官方设定资料（日文版）
...
### Case 7
**Mecha Girl Sea-City Key Visual** — 机甲少女海城主视觉
...
### Case 8
**Saint Seiya Gold Saints Card Grid** — 圣斗士星矢黄金圣斗士卡牌
...
### Case 9
**Chaos Notes Hidden Face Character Art** — 混沌笔记隐藏人脸艺术
