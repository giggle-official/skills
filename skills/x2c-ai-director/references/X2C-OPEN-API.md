...
{
  "success": true,
  "api_key": "x2c_sk_<REDACTED>xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx",
  "user_id": "uuid"
}
```
...
| X-API-Key | x2c_sk_<REDACTED>xxxx | Yes (except auth/*) |
...
```json
POST /functions/v1/open-api
Headers: { "X-API-Key": "x2c_sk_<REDACTED>xxxx" }
{
...
```json
{
  ...
  "script_pricing": [
    ...
    { "mode": "short_drama", "credits": 60, "usd": 0.60 }
  ],
  "styles": [
    { "id": 101, "name": "3D古风", "thumbnail_url": "..." }
  ],
  "categories": [
    { "id": "uuid", "name": "都市情感", "target_language": "zh-CN" }
  ]
}
```
...
```json
{
  ...
  "storyboard_shots": [
    { "id": "shot-1", "description": "...", "imageUrl": "https://..." }
  ],
  "video_url": null,
  "is_complete": false,
  "is_failed": false,
