...
const commands = {
  ...
  async 'bind'(options = {}) {
    ...
    if (!apiKey) {
      ...
      console.log('  node ad-account-manager.js bind --key "x2c_sk_<REDACTED>xxx"');
      console.log('');
      return { success: false };
    }

    // Validate key format - just check it starts with x2c_sk_
...
API Key Format: x2c_sk_<REDACTED>xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
`);
  }
};
